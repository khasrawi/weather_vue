<template>
    <div class="flex flex-col flex-1 items-center">
        ...
        <div class="flex flex-col items-center text-white py-12">
            ...
            <p>
               Feels like {{ Math.round(((weatherData.current.feels_like)-32)/1.8) }}&deg;
            </p>
            <p class="capitalize">
        ...
        <!-- Weekly Weather -->
        <div class="max-w-screen-sm w-full py-12 justify-start">
            <div class="mx-0 text-white">
                ...
                <img
                    ...
                    alt=""
                />
                <div class="flex gap-4 flex-1 justify-start pl-16">
